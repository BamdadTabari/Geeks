...
public static class PostIssueCommentQueryableExtension
{
    public static IQueryable<PostIssueComment> ApplyFilter(this IQueryable<PostIssueComment> query, DefaultPaginationFilter filter)
    {
        // Filter By id
    ...
    public static IQueryable<PostIssueComment> ApplySort(this IQueryable<PostIssueComment> query, SortByEnum? sortBy)
    {
