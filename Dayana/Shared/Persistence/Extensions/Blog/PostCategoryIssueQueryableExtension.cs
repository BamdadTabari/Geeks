...
public static class PostCategoryIssueQueryableExtension
{
    public static IQueryable<PostCategoryIssue> ApplyFilter(this IQueryable<PostCategoryIssue> query, DefaultPaginationFilter filter)
    {
        // Filter By id
    ...
    public static IQueryable<PostCategoryIssue> ApplySort(this IQueryable<PostCategoryIssue> query, SortByEnum? sortBy)
    {
